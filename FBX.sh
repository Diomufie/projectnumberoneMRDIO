...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"Dio Mufie"$bi"]"$me"======"$bi"["$i""Lebokno nomor cok""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"By :"$i" Mr Dio Mufie"
echo $ku"Github    :"$i " Github.com/diomufie"
echo $ku"Instagram :"$i" @dio_joss24"
sleep 2
